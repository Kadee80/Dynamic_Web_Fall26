...
After familiarizing the class with some React fundamentals, we will build simple mobile non native applications React Native + JSX and then style them with CSS Modules and Variables. We will learn about Authentication, Hooks, Navigation along the way.
